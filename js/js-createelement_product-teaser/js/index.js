...
// Create a const value assigned to the body
const productContainer = document.querySelector("body");
// and a second const value assigned to the article
const newProduct = document.createElement("article");
// add the class of product to it
newProduct.classList.add("product");


newProduct.innerHTML = `
    <section class="product__body">
      <div "product__text-container">
    ...
    <button type='button' class="product__buy-button data-js="buy-button"> 
      Buy 
    </button>    
    </footer>
